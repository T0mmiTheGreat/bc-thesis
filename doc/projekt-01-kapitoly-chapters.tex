...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=1.0, transform shape, every node/.style={minimum size=1cm}]
        ...
        % Person icon
        \node at (3.5,5.5) {\includegraphics[width=0.9cm]{obrazky-figures/person-icon.pdf}};
        
        % Flag icon
        \node at (7.5,2.5) {\includegraphics[width=0.6cm]{obrazky-figures/flag-icon.pdf}};
...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=1.0, transform shape, every node/.style={minimum size=1cm}]
        ...
        % Person icon
        \node at (4.5,6.5) {\includegraphics[width=0.9cm]{obrazky-figures/person-icon.pdf}};
